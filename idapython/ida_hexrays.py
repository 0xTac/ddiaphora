...
def init_hexrays_plugin(*args) -> "bool":
    ...
    Check that your plugin is compatible with hex-rays decompiler. This
    function must be called before calling any other decompiler function.
...
class Hexrays_Hooks(object):
    ...
    def print_func(self, *args) -> "int":
        ...
        print_func(self, cfunc, vp) -> int
            @param cfunc (C++: cfunc_t *)
            @param vp: Returns: 1 if text has been generated by the plugin It is
                       forbidden to modify ctree at this event.  (C++:
                       vc_printer_t *)
        """
    ...
    def build_callinfo(self, *args) -> "int":
        ...
        build_callinfo(self, blk, type, callinfo) -> int
            @param blk: blk->tail is the call.  (C++: mblock_t *)
            @param type: buffer for the output type.  (C++: tinfo_t *)
            @param callinfo: prepared callinfo. Should return: 1 if the function
                             type has been determined. The plugin should either
                             specify the function type, either allocate and return
                             a new mcallinfo_t object.  (C++: mcallinfo_t **)
        """
...
class lvar_t(lvar_locator_t):
    ...
    def append_list(self, *args) -> "void":
        ...
        append_list(self, mba, lst, pad_if_scattered=False)
            @param mba: ptr to the current  mba_t (C++: const  mba_t  *)
...
def modify_user_lvar_info(*args) -> "bool":
    ...
    modify_user_lvar_info(func_ea, mli_flags, info) -> bool
        @param func_ea: function start address (C++: ea_t)
...
def locate_lvar(*args) -> "bool":
    ...
    locate_lvar(out, func_ea, varname) -> bool
        @param out: output buffer for the variable locator (C++:
                    lvar_locator_t  *)
        @param func_ea: function start address (C++: ea_t)
        @param varname: variable name (C++: const char *)
...
def rename_lvar(*args) -> "bool":
    ...
    rename_lvar(func_ea, oldname, newname) -> bool
        @param func_ea: function start address (C++: ea_t)
        @param oldname: old name of the variable (C++: const char *)
        @param newname: new name of the variable (C++: const char *)
...
class mop_t(object):
    ...
    def create_from_vdloc(self, *args) -> "void":
        ...
        create_from_vdloc(self, mba, loc, _size)
            ...
            @param _size: operand size Note: this function cannot handle scattered
                          locations. (C++: int)
            @return: success
        """
...
class mcallarg_t(mop_t):
    ...
    flags = property(_ida_hexrays.mcallarg_t_flags_get, _ida_hexrays.mcallarg_t_flags_set)
...
class mblock_t(object):
    ...
    def get_reginsn_qty(self, *args) -> "size_t":
        ...
        Calculate number of regular instructions in the block. Assertions are
...
class mba_t(object):
    ...
    deprecated_idb_node = property(_ida_hexrays.mba_t_deprecated_idb_node_get, _ida_hexrays.mba_t_deprecated_idb_node_set)
    ...
    def set_maturity(self, *args) -> "bool":
        ...
        set_maturity(self, mat) -> bool
            @param mat (C++: mba_maturity_t)
            @return: true if it is time to stop analysis Plugins may use this
                     function to skip some parts of the analysis. The maturity
    ...
    def remove_empty_and_unreachable_blocks(self, *args) -> "bool":
        ...
        Delete all empty and unreachable blocks. Blocks marked with MBL_KEEP
        won't be deleted.
        """
    ...
    def create_helper_call(self, *args) -> "minsn_t *":
        ...
        create_helper_call(self, ea, helper, rettype=None, callargs=None, out=None) -> minsn_t
            @param ea: The desired address of the instruction (C++: ea_t)
            @param helper: The helper name (C++: const char *)
            @param rettype: The return type (NULL or empty type means 'void')
                            (C++: const  tinfo_t  *)
            @param callargs: The helper arguments (NULL-no arguments) (C++: const
                             mcallargs_t  *)
            @param out: The operand where the call result should be stored. If
                        this argument is not NULL, "mov helper_call(), out" will
                        be generated. Otherwise "call helper()" will be generated.
                        Note: the size of this operand must be equal to the
                        RETTYPE size (C++: const  mop_t  *)
...
class codegen_t(object):
    ...
    def load_operand(self, *args) -> "mreg_t":
        ...
        load_operand(self, opnum, flags=0) -> mreg_t
            @param opnum (C++: int)
            @param flags: - reserved for future use (C++: int)
    ...
    def prepare_gen_micro(self, *args) -> "merror_t":
        ...
        called before calling 'gen_micro()' . Usually 'gen_micro()' is called
        by the decompiler. You have to call this function explicitly only if
        you yourself call 'gen_micro()' . The instruction is in INSN
        """
    ...
    def load_effective_address(self, *args) -> "mreg_t":
        ...
        load_effective_address(self, n, flags=0) -> mreg_t
            @param n: - number of INSN operand (C++: int)
            @param flags: - reserved for future use (C++: int)
    ...
    def store_operand(self, *args) -> "bool":
        ...
        Generate microcode to store an operand. In case of success an
        arbitrary number of instructions can be generated (and even no
        instruction if the source and target are the same)

        store_operand(self, n, mop, flags=0, outins=None) -> bool
            @param n: - number of target INSN operand (C++: int)
            @param mop: - operand to be stored (C++: const  mop_t  &)
            @param flags: - reserved for future use (C++: int)
            @param outins: - (OUT) the last generated instruction (C++: minsn_t
                           **)
            @return: success
        """
...
class gco_info_t(object):
    ...
    def cvt_to_ivl(self, *args) -> "vivl_t":
        ...
        Convert operand info to VIVL. The returned VIVL can be used, for
        example, in a call of get_valranges().
        """
...
def create_cfunc(*args) -> "cfuncptr_t":
    ...
    create_cfunc(mba) -> cfuncptr_t
        @param mba: microcode object. After creating the cfunc object it takes
...
class vdui_t(object):
    ...
    def rename_lvar(self, *args) -> "bool":
        ...
        rename_lvar(self, v, name, is_user_name) -> bool
            ...
            @param is_user_name: use true to save the new name into the database.
                                 use false to delete the saved name. (C++: bool)
            @return: false if failed
        """
    ...
    def calc_cmt_type(self, *args) -> "cmt_type_t":
        ...
        system for comments: (https://www.hex-rays.com/blog/coordinate-system-
        for-hex-rays) some function lines cannot have comments. This function
        checks if a comment can be attached to the specified line.
